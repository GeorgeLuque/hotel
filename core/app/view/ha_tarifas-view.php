...
<body id="minovate" class="appWrapper sidebar-sm-forced">
                  ...
                  ?>
                    <table id="searchTextResults" data-filter="#filter" data-page-size="7"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index.php?view=deltarifa_ha&id=<?php echo $tarifa_ha->id; ?>&id_ha=<?php echo $tarifa_ha->id_habitacion; ?>"
                                    class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Quitar</a>
                            </td>
                        </tr>
        ...
        <div class="modal-dialog modal-success">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=addtarifa_ha"
                        role="form">
    ...
    <div class="modal fade bs-example-modal-xm" id="myEditModal" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-success">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form-horizontal" method="post" id="modproduct"
                        action="index.php?view=modtarifa_ha" role="form">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title"><span class="fa fa-sitemap"></span> MODIFICAR TARIFA</h4>
                        </div>
                        <div class="modal-body" style="background-color:#fff !important;">
                            <div class="row">
                                <div class="col-md-offset-1 col-md-10">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline pull-left"
                                data-dismiss="modal">Cerrar</button>
                            <button type="submit" class="btn btn-outline">Modificar Datos</button>
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
