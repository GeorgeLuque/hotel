...
<?php 
/*
$montos_sin_cerrar_egresos = GastoData::getIngresoRangoFechas($_POST['start'], $_POST['end']);
print_r($montos_sin_cerrar_egresos);
...
<script>
    $(window).load(function() {
        ...
        Morris.Bar({
            element: 'bar-example',
            data: [{
                y: '<?php echo $_POST['start'] . ' - ' . $_POST['end']; ?>',
                a: <?php echo $total_ingreso; ?>,
                b: <?php echo $total_egreso; ?>
            }],
            xkey: 'y',
            ykeys: ['a', 'b'],
