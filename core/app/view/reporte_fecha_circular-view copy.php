       ...
       <section class="tile">
           ...
           <div class="tile-header dvd dvd-btm">
               ...
               <ul class="controls">
                   ...
                   <li class="remove"><a href="" onclick="window.print();"><i class="fa fa-print"
                               style="color: #da0e36"></i> </a></li>
               </ul>
           </div>
           <!-- /tile header -->
       ...
       <script>
           $(window).load(function() {
               ...
               var data6 = [{
                       label: 'Venta habitación',
                       data: <?php echo ($total_sin_cerrar * 100) / $suma_total; ?>
                   },
                   {
                       label: 'Venta de productos',
                       data: <?php echo ($subtotal3 * 100) / $suma_total; ?>
                   },
                   {
                       label: 'Compra de productos',
                       data: <?php echo ($subtotal4 * 100) / $suma_total; ?>
                   },
                   {
                       label: 'Remuneraciones',
                       data: <?php echo ($total_sin_cerrar_sueldos * 100) / $suma_total; ?>
                   },
                   {
                       label: 'Gastos',
                       data: <?php echo ($total_sin_cerrar_egreso * 100) / $suma_total; ?>
                   }
               ];
