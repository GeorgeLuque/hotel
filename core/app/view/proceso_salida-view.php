...
if(count(get_object_vars($habitacion))>0){ ?>
    <div class="row">
        ...
        <section>
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item" style="border-top: 2px solid black;">
                                <b>Nombre </b> <a href="#" data-toggle="modal" data-target="#mostrar_cliente"
                                    class="pull-right"><?php echo $habitacion->getCliente()->nombre; ?></a>
                            </li>
                            <li class="list-group-item">
                            ...
                            <!-- Modal -->
                            <div class="modal fade bs-example-modal-lg" id="mostrar_cliente" tabindex="-1"
                            ...
                            foreach($tmps as $p):  ?>
                                                    <tr>
                                                        ...
                                                        <td><?php if ($p->getCliente()->giro != null and $p->getCliente()->giro != '0000-00-00') {
                                                            echo $p->getCliente()->giro;
                                                        } else {
                                                            echo '--------';
                                                        } ?></td>
                                                        <td><?php if ($p->getCliente()->direccion != 'NULL') {
                                                            echo $p->getCliente()->direccion;
                                                        } else {
                                                            echo '--------';
                                                        } ?></td>
                                                        <td><?php if ($p->getCliente()->nacionalidad != 'NULL') {
                                                            echo $p->getCliente()->nacionalidad;
                                                        } else {
                                                            echo '--------';
                                                        } ?></td>
                                                        <td><?php if ($p->getCliente()->estado_civil != 'NULL') {
                                                            echo $p->getCliente()->estado_civil;
                                                        } else {
                                                            echo '--------';
                                                        } ?></td>
                                                        <td><?php if ($p->getCliente()->ocupacion != 'NULL') {
                                                            echo $p->getCliente()->ocupacion;
                                                        } else {
                                                            echo '--------';
                                                        } ?></td>
                                                        <td><?php if ($p->getCliente()->medio_transporte != 'NULL') {
                                                            echo $p->getCliente()->medio_transporte;
                                                        } else {
                                                            echo '--------';
                                                        } ?></td>
                                                        <td><?php if ($p->getCliente()->destino != 'NULL') {
                                                            echo $p->getCliente()->destino;
                                                        } else {
                                                            echo '--------';
                                                        } ?></td>
                                                        <td><?php if ($p->getCliente()->motivo != 'NULL') {
                                                            echo $p->getCliente()->motivo;
                                                        } else {
                                                            echo '--------';
                                                        } ?></td>
                                                    </tr>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box-body box-profile">
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item" style="border-top: 2px solid black;">
                                <b>Fecha y Hora entrada</b> <b><a class="pull-right"
                                        style="color: #dd4b39;"><?php echo $habitacion->fecha_entrada; ?></a></b>
                            </li>
                            <li class="list-group-item">
                                <b>Fecha y Hora salida</b> <b><a class="pull-right"
                                        style="color: #dd4b39;"><?php echo $habitacion->fecha_salida; ?></a></b>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            } elseif ($contar_dias != 0 and $contar_hora <= 12) {
            ...
            <div class="col-md-12">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <form action="index.php?view=addsalida" method="post" name="sumar">
                                <tr>
                                    ...
                                    <input type="hidden" name="numero" size="2" value="<?php echo $habitacion->precio; ?>"
                                        onKeyUp="fncSumar()">

                                    <input type="hidden" name="numero1" size="2" value="<?php echo $habitacion->cant_noche; ?>"
                                        onKeyUp="fncSumar()">

                                    <td style="border-right: 1px solid #a09e9e;" colspan="2"><input type="number"
                                            value="0" id="numero2" name="numero2" size="2"
                                            onKeyUp="fncSumar()" onchange="fncSumar()" min="0"></td>

                                    <td><input type="text" value="<?php echo $habitacion->precio * $habitacion->cant_noche; ?>" style="border-color: red;"
                                            readonly="readonly" name="resultado" /></td>
                                </tr>
                                <tr style="background-color: #dcd6d6;">
                                </tr>
                                <tr>
                                    ...
                                    <th style="width: 40px"> <?php if($habitacion->pagado=='0'){ ?><h4 style="color: red;">FALTA PAGAR
                                        </h4><?php }else{ ?><h4 style="color: blue;">PAGADO</h4>
                                        <?php }; ?></th>
                                </tr>
                                <?php $total = 0; ?>
                      ...
                      if(count($productos)>0){ ?>
                                ...
                                <tr>
                                    ...
                                    <?php }else{ ?>
                                    <td style="border-right: 1px solid #a09e9e;">
                                        <p class="text-red">Falta Pagar</p>
                                    </td>
                                    <?php }; ?>
                                    <?php if($producto->fecha_creada!=NULL){ ?>
                                    <?php $sub_total = 0; ?>
                ...
                ?>
                                ...
                                <tr style="background-color: #dcd6d6;">
                                    <th style="width: 10px;border-right: 1px solid #a09e9e;"></th>
                                    <th colspan="4" style="border-right: 1px solid #a09e9e;">
                                        <p style="float: right;font-size: 18px;">Total Gs. </p>
                                    </th>
                                    <input type="hidden" name="subtotal" value="<?php echo $total; ?>"
                                        onKeyUp="fncSumar()">
                                    <?php if ($habitacion->pagado == '1') {
                                        $sumarrr = 0;
                                    } else {
                                        $sumarrr = $habitacion->precio * $habitacion->cant_noche;
                                    } ?>
                                    <th style="width: 100px;"><b><input type="text" style="border-color: green;"
                                                readonly name="total" value="<?php echo $total + $sumarrr; ?>"></b></th>
                                </tr>
                                <?php if($habitacion->pagado=='0'){ ?>
                                <tr style="background-color: #dcd6d6;">
                                    <th style="width: 10px;border-right: 1px solid #a09e9e;"></th>
                                    <th colspan="4" style="border-right: 1px solid #a09e9e;">
                                        <p style="float: right;font-size: 14px;">Tipo de pago</p>
                                    </th>
                                    <th style="width: 100px;"><b>
                                            <select class="form-control" onchange="CargarMediopago(this.value);"
                                                required name="id_tipo_pago">
                                ...
                                <tr style="background-color: #dcd6d6;">
                                    <th style="width: 10px;border-right: 1px solid #a09e9e;"></th>
                                    <th colspan="4" style="border-right: 1px solid #a09e9e;">
                                        <p style="float: right;font-size: 14px;">Nro operación </p>
                                    </th>
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <button type="submit" name="factura" class="btn btn-warning pull-right"
                            style="margin-right: 10px;"><i class='fa fa-print'></i> Imprimir Factura</button>

                        <button type="submit" name="ticket" class="btn btn-primary pull-right"
                            style="margin-right: 10px;"><i class='fa fa-print'></i> Imprimir Ticket</button>
                    </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">ACEPTAR</span></button>
