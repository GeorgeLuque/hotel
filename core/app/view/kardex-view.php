              ...
              <div class="input-group">
                ...
                <input type="text" id="txtMes" name="txtMes" placeholder=""
                 ...
                 <select class="form-control" name="anio">
                   <option value="2024" <?php if($anio=='2017'){ echo "selected";}; ?>>2024</option>
                   <option value="2024" <?php if($anio=='2018'){ echo "selected";}; ?>>2024</option>
                   <option value="2024" <?php if($anio=='2019'){ echo "selected";}; ?>>2024</option>
                   <option value="2024" <?php if($anio=='2020'){ echo "selected";}; ?>>2024</option>
                   <option value="2024" <?php if($anio=='2021'){ echo "selected";}; ?>>2024</option>
                   <option value="2024" <?php if($anio=='2022'){ echo "selected";}; ?>>2024</option>
                 </select>
               </div>
            </div>
            <div class="col-sm-3">
