...
<body id="minovate" class="appWrapper sidebar-sm-forced">
    ...
    <div class="breadcrumb-line">
        ...
        <div class="row">
            <div class="breadcrumb col-lg-12">
                <div
                    style="background-color: #16a085;color: white;padding: 2px;font-size: 20px;
    ...
    <section class="tile col-md-6 col-md-offset-3">
        ...
        <!-- tile body -->
        <form method="post" action="index.php?view=reporte_hora_barra">
            <div class="tile-body">
            ...
            <div class="tile-footer">
                <div class="form-group text-center">
                    ...
                    <button class="btn btn-rounded btn-success ripple" type="submit"><i class="fa fa-open-eye"></i> Ver
                        informe</button>
                </div>
            </div>
        </form>
