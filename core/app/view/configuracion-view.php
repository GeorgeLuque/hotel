  ...
  <div class="content-wrapper">
      ...
      <section class="content">
          <div class="row">
                  ...
                  <div class="box box-solid">
                      ...
                      <div class="box-body no-padding">
                          ...
                          <ul class="nav nav-tabs nav-stacked">
                              <li class="active"><a href="#tab_1" data-toggle="tab" class="btn-primary">PRINCIPAL</a>
                              </li>

                              <li><a href="#tab_3" data-toggle="tab" class="btn-primary"> <i
                                          class="fa fa-filter"></i>OTROS</a></li>
                      ...
                      <div class="tab-content">
                          <div class="tab-pane active" id="tab_1">
                              <div class="box box-primary">
                                  <div class="box-header with-border">
                                      <h3 class="box-title">Defina el nombre de su empresa de la manera como desea que
                                          aparezca en las pantallas y reportes</h3>
            ...
            if(count(get_object_vars($configuracion))>0){ 
              ...
              $id=$configuracion->id; ?>
                                  ...
                                  <form class="form-horizontal" method="post" id="addproduct"
                                      action="index.php?view=updateconfiguracion" role="form">
              ...
              $id=0; ?>
                                      <form class="form-horizontal" method="post" id="addproduct"
                                          action="index.php?view=addconfiguracion" role="form">
                                          <?php }
            ?>
                                          <!-- /.box-header -->
                                          <div class="box-body no-padding">
                                                      ...
                                                      <div class="form-group">
                                                          <div class="input-group">
                                                              ...
                                                              <input type="text" class="form-control" name="telefono"
                                                                  placeholder="Teléfono" value="<?php if ($telefono != 'NULL') {
                                                                      echo $telefono;
                                                                  } ?>">
                                                          </div>
                                                      </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="fax"  placeholder="Fax" value="<?php if ($fax != 'NULL') {
                          echo $fax;
                      } ?>">
                    </div>
                  </div>
                                                      ...
                                                      <div class="form-group">
                                                          ...
                                                          <div class="input-group">
                                                              ...
                                                              <input type="text" class="form-control col-md-12"
                                                                  name="rnc" value="<?php if ($rnc != 'NULL') {
                                                                      echo $rnc;
                                                                  } ?>">
                                                          </div>
                                                      </div>
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-12" name="registro_empresarial" value="<?php if ($registro_empresarial != 'NULL') {
                          echo $registro_empresarial;
                      } ?>">
                    </div>
                  </div>
              ...
              -->
                                                      ...
                                                      <div class="form-group">
                                                          ...
                                                          <div class="input-group">
                                                              <span class="input-group-addon"> Ciudad
                                                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                              <input type="text" class="form-control col-md-12"
                                                                  name="ciudad" value="<?php if ($ciudad != 'NULL') {
                                                                      echo $ciudad;
                                                                  } ?>">
                                                          </div>
                                                      </div>
                                              ...
                                              <div class="box-footer">
                                                  ...
                                                  <input type="hidden" name="id_configuracion"
                                                      value="<?php echo $id; ?>">
                                                  <button type="submit" class="btn btn-primary">Actualizar datos de
                                                      la empresa</button>
           ...
           // print_r($config);
          //  if(count($config)>0){ 
              if (count(get_object_vars($config)) > 0){
              $logo=$config->logo;
              $id_config=$config->id; ?>
                                  ...
                                  <!-- /.box-header -->
                                  <form class="form-horizontal" method="post" id="addproduct"
                                      action="index.php?view=updatelogo" enctype="multipart/form-data"
                                      role="form">
                                      <div class="box-body no-padding">
