...
<body id="minovate" class="appWrapper sidebar-sm-forced">
                  ...
                  ?>
                    <table id="searchTextResults" data-filter="#filter" data-page-size="7"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" data-toggle="modal" data-target="#myModal<?php echo $tarifa->id; ?>"
                                    class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-edit"></i> Editar</a>
                            </td>
                            <td>
                                <a href="index.php?view=deltarifa&id=<?php echo $tarifa->id; ?>"
                                    class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Eliminar</a>
                            </td>
                        </tr>


                        <div class="modal fade bs-example-modal-xm" id="myModal<?php echo $tarifa->id; ?>" role="dialog"
                            aria-labelledby="myModalLabel">
                            <div class="modal-dialog modal-warning">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form class="form-horizontal" method="post" id="addproduct"
                                            action="index.php?view=updatetarifa" role="form">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span></button>
                                                <h4 class="modal-title"><span class="fa fa-sitemap"></span> EDITAR
                                                    TARIFA</h4>
                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="nombre"
                                                                value="<?php echo $tarifa->nombre; ?>" required
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="hidden" class="form-control" name="id_tarifa"
                                                    value="<?php echo $tarifa->id; ?>">
    ...
    <div class="modal fade bs-example-modal-xm" id="myModal" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-success">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=addtarifa"
                        role="form">
                        <div class="modal-header">
