    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" style="background-color: #d2d6de;">
                ...
                <li class="pull-right text-red"><a href="javascript:print();" class="text-muted"><i
                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="#" data-toggle="modal"
                                    data-target="#mostrar_cliente<?php echo $reportediario->id; ?>"><?php echo $reportediario->getCliente()->nombre; ?></a>

                                <!-- Modal -->
                                <div class="modal fade bs-example-modal-lg" id="mostrar_cliente<?php echo $reportediario->id; ?>"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                      ...
                                      foreach($tmps as $p):  ?>
                                                        <tr>
                                                            ...
                                                            <td><?php if ($p->getCliente()->fecha_nac != null and $p->getCliente()->fecha_nac != '0000-00-00') {
                                                                echo $p->getCliente()->fecha_nac;
                                                            } else {
                                                                echo '--------';
                                                            } ?></td>
