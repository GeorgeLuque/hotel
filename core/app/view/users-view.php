                  ...
                  ?>
                    <table id="searchTextResults" data-filter="#filter" data-page-size="7"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index.php?view=edituser&id=<?php echo $user->id; ?>"
                                    class="btn btn-warning btn-xs"><i class="fa fa-edit"></i>Editar</a>
                            </td>
                            <td>
                                <a href="index.php?view=deluser&id=<?php echo $user->id; ?>"
                                    class="btn btn-danger btn-xs"><i class="fa fa-edit"></i>Eliminar</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
        ...
        <div class="modal-dialog modal-success">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=adduser"
                        role="form">
                                ...
                                <div class="col-md-offset-1 col-md-10">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control col-md-8" name="lastname"
                                                required placeholder="Ingrese Apellido">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control col-md-8" name="email"
                                                required placeholder="Ingrese Correo">
                                        </div>
                                    </div>
